...
#             self.theta_threshold_radians * 2,
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.viewer is None:
            ...
            self.balltrans1 = rendering.Transform(translation=(0, 0))
            ...
            l = 0.2/2*scale
            h = 2.0/2*scale
            ball2 = rendering.FilledPolygon([(l,0), (l,h), (-l,h), (-l,0)])
...
#        self.balltrans1.set_translation(x1*scale+screen_width/2.0, 0*scale+screen_height/2.0)
        self.balltrans1.set_translation(x1*scale+screen_width/2.0, 0*scale+screen_height/2.0)
        self.balltrans2.set_rotation(math.asin(body2.getRotation()[1]))
